...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    if (!this.value) {
      // if no value is present, stop here
  ...
  searchInput.on('keyup', function (e) {
    // if they aren't hitting up(38), down(40), or enter (13), ignore
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near/?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    //create a bounds so google maps will center and zoom in
    ...
    var markers = places.map(function (place) {
      ...
      // tell google maps to extend bounds to include this position as viewable
    ...
    // when someone clicks on a marker, show that place's details
